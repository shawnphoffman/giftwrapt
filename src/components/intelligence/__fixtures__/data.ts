...
const recStaleItems: Recommendation = {
	...
	actions: [
		...
		},
		{
			...
			description: 'Permanently delete all three items. None have claims, so no gifters are affected.',
			intent: 'destructive',
			confirmCopy: 'Permanently delete these 3 items from My Wishlist? This cannot be undone.',
		},
	],
