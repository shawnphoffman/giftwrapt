	...
	return (
		<div className="animate-page-in">
			...
			<CardContent className="flex flex-col gap-4">
				<p className="text-sm text-muted-foreground">View and manage your gift purchases and spending.</p>
				<div className="flex flex-col gap-2">
					<Link to="/purchases" className="flex items-center gap-2 p-3 border rounded-lg hover:bg-muted/50">
					...
					<Link to="/purchases/summary" className="flex items-center gap-2 p-3 border rounded-lg hover:bg-muted/50">
						<div className="flex-1">
