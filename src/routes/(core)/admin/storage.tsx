	...
	return (
		<Card className="animate-page-in">
			<CardHeader>
				<CardTitle className="text-2xl">Storage</CardTitle>
				<CardDescription>
					Every object in the configured bucket. Rows are classified as <strong>attached</strong> when a user or item still references them,
					or <strong>orphan</strong> when nothing in the database points at the key. Bulk-delete orphans or remove a single object below.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<ClientOnly>
