			...
			<div className="max-w-2xl mx-auto">
				...
				>
					<form onSubmit={handleSubmit} className="space-y-6">
						<Input label="First Name" id="firstName" value={firstName} onChange={setFirstName} placeholder="John" required />
						...
						<Slider label="Coffee Cups Per Day" id="coffeeCups" value={coffeeCups} onChange={setCoffeeCups} min={0} max={10} />
					</form>
				</Dialog>
			</div>
		</div>
